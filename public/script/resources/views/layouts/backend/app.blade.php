...
<!-- Custom styles for this template-->
    ...
    <!-- Toastr notification -->
    <link rel="stylesheet" href="{{ asset('templates/backend/sb-admin-2/css/toastr.min.css') }}">
</head>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <!-- End of Topbar Navbar -->
            ...
            <div class="container-fluid">
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">{{ isset($pageTitle) ? $pageTitle : 'Dashboard' }}</h1>
                @yield('content')
            </div>
            <!-- /.container-fluid -->
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Sara {{ date('Y') }}</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
...
<script src="{{ asset('templates/backend/sb-admin-2/js/toastr.min.js') }}"></script>
