...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="{{ route('experiences.index') }}" class="btn btn-danger btn-sm">Cancel</a>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('experiences.update', $experience->id) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('title') is-invalid @enderror" name="title" id="title"
                           type="text" value="{{ $experience->title }}">
                    @error('title')
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('date') is-invalid @enderror" name="date" id="date"
                           type="text" value="{{ $experience->date }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('icon') is-invalid @enderror" name="icon" id="icon"
                           type="text" value="{{ $experience->icon }}">
                    <small>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('organisation') is-invalid @enderror" name="organisation"
                           id="organisation"
                           type="text" value="{{ $experience->organisation }}">
                    @error('organisation')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea cols="30" rows="5" class="form-control @error('description') is-invalid @enderror"
                              name="description"
                              id="description">{{ $experience->description }}</textarea>
                    @error('description')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
