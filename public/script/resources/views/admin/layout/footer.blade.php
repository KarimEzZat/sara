                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="custom-control custom-switch float-right">
                            <input type="checkbox" <?= $checked ?> value="{{ $footer->is_active }}"
                                class="custom-control-input activate" data-id="{{ $footer->id }}" id="{{ $footer->id }}">
                            <label class="custom-control-label switch" for="{{ $footer->id }}"></label>
                        </div>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">{{ $footer->owner }}</h5>
